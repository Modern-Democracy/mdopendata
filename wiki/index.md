...
| [Staged PDF artifact version 2 implementation plan](./implementation/staged-pdf-artifact-v2-implementation-plan.md) | Gated implementation sequence with Phase 0 baseline controls and Phase 1 schema and validator complete; migration and later reviewer work remain pending. |
