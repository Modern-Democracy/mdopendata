...
| [Staged PDF artifact version 2 implementation plan](./implementation/staged-pdf-artifact-v2-implementation-plan.md) | Gated implementation sequence with Phases 0 through 5 complete and the Phase 6 deterministic agenda-package reuse preview in progress. |
