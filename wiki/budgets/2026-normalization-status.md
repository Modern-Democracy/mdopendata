...
- Reviewed all 13 capital budget schedules and 24 capital project profiles. The schedules map 222 rows and 246 monetary facts with explicit detail, deduction, and reported-total roles. Profiles preserve project, department, description, and strategic-alignment text while excluding narrative years, quantities, and dimensions from financial facts.
